...
# Argone theme
git clone --depth=1 -b master https://github.com/hza81007155/luci-theme-argone package/luci-theme-argon
git clone --depth=1 -b master https://github.com/hza81007155/luci-app-argone-config.git package/luci-app-argon-config
